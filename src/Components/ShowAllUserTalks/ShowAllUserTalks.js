...
import {getAllUserTalks, handleUserTalkByID} from '../../redux/action/talkAction';
          ...
          return (
            <Grid key={talk._id}  item>
              <Talk {...talk} 
                ...
                handleUserTalkByID={this.props.handleUserTalkByID}
                />
            </Grid>
             )
            })
...
export default connect(mapStateToProps, { getAllUserTalks, handleUserTalkByID })(withRouter(withStyles(styles)(AllUserTalks)));